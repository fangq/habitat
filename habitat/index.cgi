...
# ApplyRegExpRules, _ExpandBackrefs moved to Habitat::Render.

# EvalLocalRules, ScrubRawHtml, QuoteHtml moved to Habitat::Render.
...
# GetBracketUrlIndex moved to Habitat::Render.
