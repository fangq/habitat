...
cmp_ok( scalar( keys %seen ),
    '>', 50, "1000 random bytes hit more than 50 distinct byte values (not all-zero)" );
...
ok( HabitatEngine::ConstantEq( $sig,  HabitatEngine::Hmac("token") ), "fresh HMAC compares equal" );
